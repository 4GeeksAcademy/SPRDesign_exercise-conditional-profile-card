...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
    ...
    variables.github == null ? "fab fa-github" : "fab fa-github"
  }"></i></a>
  </li>

            <li><a href="${variables.linkedin}"><i class="${
    variables.linkedin == null ? "fab fa-linkedin" : "fab fa-linkedin"
  }"></i></a>
  </li>

           <li><a href="${variables.instagram}"><i class="${
    variables.instagram == null ? "fab fa-instagram" : "fab fa-instagram"
  }"></i></a>
  </li>
